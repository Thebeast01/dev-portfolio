...
export default function Home() {
    ...
    return (
        // pt-24 pushes content below the fixed navbar (h-20 + top-1 + a little breathing room)
        <div className="min-h-screen px-4 pt-24 pb-4 w-full text-neutral-950 items-center justify-center flex">
            <motion.div
                ref={ref}
            ...
            >
                ...
                <div className="relative w-full h-full space-y-3 ">
                    ...
                    <p className="flex text-neutral-950/70 dark:text-neutral-50 text-lg flex-wrap items-center text-left tracking-tighter">
                        I&apos;m a full-stack developer passionate about building fast, scalable and user-focused
                        digital products. I specialize in JavaScript and TypeScript ecosystems, delivering
                        end-to-end solutions across web and mobile platforms.
                    </p>
                </div>

                <div className="relative w-full h-96 md:w-[650px]">
                    {/* ✅ leading slash — public folder assets must start with "/" */}
                    <Image src="/hero.svg" alt="Hero illustration" fill className="object-contain" />
                </div>
            </motion.div>
        </div>
    )
